...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `candidatemanagement`.`Organization` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `candidatemanagement`.`SubOrganization` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `candidatemanagement`.`Role` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `candidatemanagement`.`Department` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `candidatemanagement`.`Employee` ;
